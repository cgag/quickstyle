...
var jscolor = {
  ...
  imagesBase64 : { 
    ...
    console.log(jscolor.imgRequire);
	...
	loadImage : function(filename) {
		if(!jscolor.imgLoaded[filename]) {
			...
			jscolor.imgLoaded[filename].setAttribute('src', jscolor.imagesBase64[filename]);
		}
	},
	...
	color : function(target, prop) {
		...
		function drawPicker(x, y) {
			...
			p.padM.style.backgroundImage =  "url('" + jscolor.imgLoaded['cross.gif'].src + "')"
        //jscolor.imgLoaded['cross.gif']; // "url('"+jscolor.getDir()+"cross.gif')";
			p.padM.style.backgroundRepeat = "no-repeat";
			p.sldM.style.backgroundImage = "url('" + jscolor.imgLoaded['arrow.gif'].src + "')"
			p.sldM.style.backgroundRepeat = "no-repeat";
			p.pad.style.backgroundImage = "url('" + jscolor.imgLoaded[padImg].src + "')"
        //jscolor.imgLoaded[padImg] // "url('"+jscolor.getDir()+padImg+"')";
